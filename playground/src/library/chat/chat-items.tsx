...
export function UserChatMessage(props: ChatItemProps) {
  return (
    <View textAlign="right" paddingLeft={20} paddingRight={20}>
      <Card lineHeight={2}>
  ...
  return (
    <View textAlign="left" paddingLeft={20} paddingRight={20}>
      <View lineHeight={2}>
        <Text>
          <pre>
            <code>{tryFixJsonString(props.text)}</code>
          </pre>
        </Text>
      </View>
    </View>
...
export function AgentGraphQLBlock(
  props: { invoke: () => void } & ChatItemProps
) {
  return (
    <View textAlign="left" paddingLeft={20} paddingRight={20}>
      <View lineHeight={2}>
  ...
  return (
    <View textAlign="left" paddingLeft={20} paddingRight={20}>
      <View lineHeight={2}>
        ...
        <pre>
          <code>
            <Text>{tryFixJsonString(props.text)}</Text>
          </code>
        </pre>
      </View>
    </View>
